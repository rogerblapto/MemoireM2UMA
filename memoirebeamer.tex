...
\begin{document}
	...
	\begin{frame}{Introduction}
		\begin{itemize}
			\item Les représentations linéaires d'un groupe \( G \) sur un espace vectoriel \( V \) sont des homomorphismes \( \varphi: G \to \text{GL}(V) \).
			\item Un groupe infini est un groupe qui possède une infinité d'éléments.
			\item L'objectif est d'étudier les représentations linéaires des groupes infinis et leurs applications dans des domaines comme la physique théorique, la géométrie et la cryptographie.
			\item Les représentations linéaires d'un groupe \( G \) sur un espace vectoriel \( V \) sont des homomorphismes \( \varphi: G \to \text{GL}(V) \).
			\item Un groupe infini est un groupe qui possède une infinité d'éléments.
			\item L'objectif est d'étudier les représentations linéaires des groupes infinis et leurs applications dans des domaines comme la physique théorique, la géométrie et la cryptographie.
			\item Les représentations linéaires d'un groupe \( G \) sur un espace vectoriel \( V \) sont des homomorphismes \( \varphi: G \to \text{GL}(V) \).
...
\begin{frame}
	...
	\begin{definition} 
		...
		\begin{enumerate}[label=\roman*)]
			...
			\item \textbf{Anti-symétrie} : si \(a \leq b\) et \(b \leq a\), alors \(a = b\) ;
			\item \textbf{Transitivité} : si \(a \leq b\) et \(b \leq c\), alors \(a \leq c\).
		\end{enumerate}
	\end{definition}
...
\begin{frame}
	\frametitle{Définitions et Propositions}
...
\begin{frame}
	\frametitle{Notations et Définitions}
	...
	\begin{definition}[Système projectif de groupes]
		\cite{maclane1971categories}
...
\begin{frame}{Représentations des groupes infinis}
\begin{definition}[Famille compatible avec le système projectif]
	\cite{maclane1971categories}
...
\begin{frame}
\begin{definition}[Limite projective]
	\cite{maclane1971categories}
...
\end{frame}
	...
	\section{Notion de représentation linéaire de groupes finis}
	...
	\begin{frame}
		...
		\begin{block}{Remarque} \cite{serre1971representation}
...
\end{frame}
	...
	\section{Produit tensoriel et représentation linéaire d'un produit de groupes finis}
	...
	\section{Applications des Représentations Linéaires}
	\begin{frame}{Applications en Physique}
		\begin{itemize}
			\item Les groupes de symétrie et leurs représentations jouent un rôle crucial en physique théorique, en particulier dans les théories quantiques.
			\item Exemple : Les groupes de Lie sont utilisés pour décrire les symétries des systèmes physiques.
			\item Les représentations unitaires des groupes de Lie sont fondamentales pour l'étude des particules élémentaires.
		\end{itemize}
	\end{frame}
	
	\begin{frame}{Applications en Cryptographie et Géométrie}
		\begin{itemize}
			\item En cryptographie, les représentations des groupes de matrices sont utilisées dans les systèmes de chiffrement et les algèbres de Lie.
			\item En géométrie, les représentations des groupes de symétrie sont essentielles pour l'étude des surfaces de Riemann et des variétés.
		\end{itemize}
	\end{frame}
	...
	\begin{frame}{Conclusion}
		\begin{itemize}
			\item Les représentations linéaires des groupes infinis sont essentielles pour la compréhension des symétries dans des domaines variés tels que la physique, la géométrie et la cryptographie.
			\item Les méthodes modernes, comme la cohomologie des groupes et l'analyse catégorique, ouvrent de nouvelles perspectives dans ce domaine.
		\end{itemize}
	\end{frame}
